...
print 'double xsecWeights[8]={0.297252,0.0718248,0.0231878,90.2367,0.0672527,8.99789e+07,7.82602,1};'#{0.00772,1.0,0.0246,1.0,4.79,1};'
...
print '            EventWeight=xsecWeights[processInt];'#read.Weight;'
...
if len(data.list_Categories)>0:
    ...
    for icate in data.list_Categories:
       ...
       print 'TLorentzVector Jet1=read.Jet0->at(0);TLorentzVector Jet2=read.Jet1->at(0);TLorentzVector RSG=Jet1+Jet2;'
       print 'double Rap1=0.5*log((Jet1.E()+Jet1.P())/(Jet1.E()-Jet1.P()));double Rap2=0.5*log((Jet2.E()+Jet2.P())/(Jet2.E()-Jet2.P()));'
       print 'double delY=fabs(Rap1-Rap2);'

       print 'int NumTags=0;'
       print 'double CSVM=0.8;'
       print 'double J1S0=read.Jet0SDsubjet0bdisc;'
       print 'double J1S1=read.Jet0SDsubjet1bdisc;'
       print 'double J2S0=read.Jet1SDsubjet0bdisc;'
       print 'double J2S1=read.Jet1SDsubjet1bdisc;'

       print 'if(J1S0>CSVM || J1S1 >CSVM){NumTags=NumTags+1;}'
       print 'if(J2S0>CSVM || J2S1 >CSVM){NumTags=NumTags+1;}'


       print 'bool catA=false;'
       print 'bool catB=false;'
       print 'bool catC=false;'
       print 'bool catD=false;'
       print 'bool catE=false;'
       print 'bool catF=false;'


       print 'if(delY<1.0 && NumTags==0){catA=true;}'
       print 'if(delY<1.0 && NumTags==1){catB=true;}'
       print 'if(delY<1.0 && NumTags==2){catC=true;}'
       print 'if(delY>1.0 && NumTags==0){catD=true;}'
       print 'if(delY>1.0 && NumTags==1){catE=true;}'
       print 'if(delY>1.0 && NumTags==2){catF=true;}'
