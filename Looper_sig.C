...
double xsecWeights[8]={0.297252*0.12,0.0718248*0.12,0.0231878*0.12,90.2367*0.12,0.0672527*0.12,8.99789e+07*0.12,7.82602*0.12,1};
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::A(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::B(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::C(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::D(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::E(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::F(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_RSGPt(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_RSGMass(TChain *tr,classInst& read,string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_DeltaRJ1J2(TChain *tr,classInst& read,string ProcessName,int iEvent){
TLorentzVector Jet1=read.Jet0->at(0);TLorentzVector Jet2=read.Jet1->at(0);double DeltaR=Jet1.DeltaR(Jet2);return DeltaR;
}

template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_DeltaEtaJ1J2(TChain *tr,classInst& read,string ProcessName,int iEvent){
TLorentzVector Jet1=read.Jet0->at(0);TLorentzVector Jet2=read.Jet1->at(0);double DeltaEta=Jet1.Eta()-Jet2.Eta();return DeltaEta;
}

template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_DeltaPhiJ1J2(TChain *tr,classInst& read,string ProcessName,int iEvent){
